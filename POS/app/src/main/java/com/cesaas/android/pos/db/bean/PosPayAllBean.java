...
public class PosPayAllBean {
    ...
    private String OrderType;//订单类型 0：独立收银，1：订单推送
    private String OrderStatus;//订单状态 0：异常单，1：正常

    public PosPayAllBean(){}
    public PosPayAllBean(String shopId, String shopName, String createName, String orderNo, String amount
