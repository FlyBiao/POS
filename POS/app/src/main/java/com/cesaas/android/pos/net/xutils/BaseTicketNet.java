...
public class BaseTicketNet {
	...
	public BaseTicketNet(Context context, boolean show) {
...
//					Log.i(TAG, "auth=="+data);
			...
			Log.i(Constant.TAG,"发送请求:" +"URL=:"+ Urls.SERVER + uri + "--数据参数=:" + data);
			
			HttpUtils http = new HttpUtils();
			http.send(HttpMethod.POST, Urls.SERVER + uri, params, new RequestCallBack<HttpUtils>() {
				@Override
