 ...
 * ================================================
 */
public class PayCategoryDetailNet extends BaseNet {

    private ACache mCache;
    public PayCategoryDetailNet(Context context, ACache mCache) {
        super(context, true);
    ...
    protected void mSuccess(String rJson) {
        ...
        Log.i("test","GetPayCategory:"+rJson);
        ResultPayCategoryDetailBean bean= JsonUtils.fromJson(rJson,ResultPayCategoryDetailBean.class);
