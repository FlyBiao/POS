...
public class PosPayCategoryDetailAdapter extends SwipeMenuAdapter<PosPayCategoryDetailAdapter.DefaultViewHolder> {

    public List<ResultPayCategoryDetailBean.PayCategoryBea> categoryBeaList;
    private OnItemClickListener mOnItemClickListener;
    public static int payType;

    public PosPayCategoryDetailAdapter(List<ResultPayCategoryDetailBean.PayCategoryBea> categoryBeaList, int payTypes){
