package com.cesaas.android.pos.storedvalue.adapter;
...
public class PosPayCategoryListAdapter extends SwipeMenuAdapter<PosPayCategoryListAdapter.DefaultViewHolder> {

    public List<ResultPayCategoryListBean.PayCategoryBea> categoryBeaList;
    private OnItemClickListener mOnItemClickListener;
    public static int payType;

    public PosPayCategoryListAdapter(List<ResultPayCategoryListBean.PayCategoryBea> categoryBeaList, int payTypes){
