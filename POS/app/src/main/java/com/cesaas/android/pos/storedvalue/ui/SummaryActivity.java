...
import com.cesaas.android.pos.net.xutils.net.value.GetPosRechargeListNet;
import com.cesaas.android.pos.storedvalue.adapter.PosRechargeListAdapter;
...
import com.cesaas.android.pos.storedvalue.bean.ShopStoredValueLatticePrinterBean;
import com.cesaas.android.pos.storedvalue.bean.ShopStoredValueLatticePrinterInfoBean;
    ...
    public void onDataSynEvent(ResultGetPosRechargeListBean bean) {
        if(bean.isSuccess()!=false){
            ...
            if(bean.TModel!=null && bean.TModel.size()!=0){
                ...
                tv_CurrentTotalAmount.setText(currentTotalAmount+"");
                tv_CurrentGivenTotalAmount.setText(currentGivenTotalAmount+"");
