 ...
 * ================================================
 */
public class OrderCashierPrinterTools {
     ...
     */
    public static void printLattice(Context context, LatticePrinter latticePrinter, LatticePrinterBean printerBean, ArrayList<ResultGetOrderBean.OrderDetailBean> listOrder,double discount) {
        String mediumSpline = "";
        ...
        int sizeTitle = largeSize - OrderCashierPrinterTools.length(title);
        ...
        String marchent1 = "原价："+listOrder.get(0).TotalPrice;
        latticePrinter.printText(marchent1 + "\n", LatticePrinter.FontFamily.SONG,
                LatticePrinter.FontSize.MEDIUM, LatticePrinter.FontStyle.BOLD);

        String time1 = "折后金额："+listOrder.get(0).TotalPrice;
        ...
        String shopTitle = "商品名称     数量     金额";
        latticePrinter.printText(shopTitle + "\n", LatticePrinter.FontFamily.SONG, LatticePrinter.FontSize.MEDIUM,
                LatticePrinter.FontStyle.BOLD);
        ...
        for (int i=0;i<listOrder.size();i++){
            dataList.add(listOrder.get(i).OrderItem.get(0).Title+"          "+listOrder.get(i).OrderItem.get(0).Quantity+"         ￥"+listOrder.get(i).OrderItem.get(0).Price);
            totalNumber+=listOrder.get(i).OrderItem.get(0).Quantity;
        }
        ...
        String sum = "合算"+"         总数:"+totalNumber+"    总额:"+listOrder.get(0).TotalPrice;
        latticePrinter.printText(sum + "\n", LatticePrinter.FontFamily.SONG, LatticePrinter.FontSize.MEDIUM,
                LatticePrinter.FontStyle.BOLD);
        ...
        latticePrinter.printText(heji + "\n", LatticePrinter.FontFamily.SONG,
                LatticePrinter.FontSize.MEDIUM, LatticePrinter.FontStyle.BOLD);
        String totalPrice = "总额："+listOrder.get(0).TotalPrice;
