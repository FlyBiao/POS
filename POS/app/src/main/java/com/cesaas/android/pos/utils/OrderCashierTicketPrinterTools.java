 ...
 * ================================================
 */
public class OrderCashierTicketPrinterTools {
     ...
     */
    public static void printLattice(Context context, LatticePrinter latticePrinter, LatticePrinterOrderBean printerBean, double discount) {
        String mediumSpline = "";
...
//                IPrint.Gravity.CENTER);
        ...
        int sizeTitle = largeSize - OrderCashierTicketPrinterTools.length(title);
        ...
        String activityPlan = "活动优惠:"+printerBean.getActivityPlan();
        latticePrinter.printText(activityPlan + "\n", LatticePrinter.FontFamily.SONG,
                LatticePrinter.FontSize.MEDIUM, LatticePrinter.FontStyle.BOLD);
